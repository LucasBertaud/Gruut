 ...
 */
final class Version20230214081935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ratings (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, product_id INT DEFAULT NULL, rating INT NOT NULL, text LONGTEXT DEFAULT NULL, INDEX IDX_CEB607C9A76ED395 (user_id), INDEX IDX_CEB607C94584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
